    ...
    <div class="hero">
      <div class="container">
        <div class="hero-content">
          ...
          <a href="{{route('auth.register')}}"><button class="btn btn--primary">Get Started Now</button></a>
        </div>
      </div>
    </div>
  </header>
    ...
    <section id="contact" class="contact">
      <div class="row contactus">
        ...
        @method('post') 
              ...
              <input type="text" name="" placeholder="eg: John Doe" name="name">
            
              <input type="text" name="" placeholder="eg: johndoe@gmail.com" name="email">
          
              <input type="text" name="" placeholder="Title/Subject/Reason" name="title">
       
              <textarea name="" rows="6" placeholder="Write your message" name="messages"></textarea>
